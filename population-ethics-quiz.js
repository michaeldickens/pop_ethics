...
function bullets(){
    ...
    if(ANS.same_number==="none" || ANS.same_number==="equal"){
        ...
        out.push({t:"Once the people changed, how well the lives go stopped counting.",b:"Same headcount, every life in the second future far better than every life in the first, and not one person in both — and "+sroute+". This is the person-affecting thought at full strength: nothing is better or worse unless it is better or worse <em>for</em> somebody, and here there is nobody it could be better for. "+scost+" The price is how much ground it covers. Almost any choice with a long horizon shifts who gets conceived, and so who is ever born; on your answer your ordering has nothing to say about the futures those choices decide between, however well or badly the lives in them go. Note what is <em>not</em> doing the work: nobody is added, nobody is missing, and no life here is anywhere near the level where it stops being worth living."});
    }
