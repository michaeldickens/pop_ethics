...
- `analyse_logs.py`: Summarises that log — who answered what, which conflicts and bullets people hit, and how the answers hang together. Defaults to a public mode that drops runs whose taker declined consent and prints nothing identifying; `--mode private` keeps everything and stamps the report do-not-share.
